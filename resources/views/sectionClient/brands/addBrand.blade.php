                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            <div class="row justify-content-center py-20">
                                ...
                                <form class="js-validation-material" action="{{route('save-brand-page')}}" method="post" autocomplete="off">
                                    @csrf
                                        <div class="form-group">
                                            <div class="form-material">
                                                <input type="text" class="form-control" id="val-username2" name="brand_name" placeholder="Enter a brand.." autocomplete="false">
