                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            <div class="row justify-content-center py-20">
                                ...
                                <form class="js-validation-material" action="{{route('update-category-page',$cate->id)}}" method="post" autocomplete="off">
                                    @csrf
                                    @method("PUT")
                                        <input type="hidden" name="category_id" value="{{$cate->id}}">
                                        <div class="form-group">
                                            <div class="form-material">
                                                <input type="text" class="form-control" id="val-username2" name="category_name" value="{{$cate->category_name}}" placeholder="Enter a category.." autocomplete="false">
