...
@section('content')
    <div class="content">
        <h2 class="content-heading">Add New Product</h2>
                    <div class="block">
                        ...
                        <div class="block-content">
                            <div class="row justify-content-center py-20">
                                ...
                                <form class="js-validation-material" action="{{route('save-product-page')}}" method="post" autocomplete="off">
                                    @csrf
                                        <div class="form-group">
                                            <div class="form-material">
                                                <input type="text" class="form-control" id="val-username2" name="product_name" placeholder="Enter a username.." autocomplete="false">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-alt-primary"><i class="si si-shopping-bag" aria-hidden="true"></i> Add Product</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
